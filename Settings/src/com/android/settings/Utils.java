...
public class Utils {
	...
	// B -> MB
	public static String convertToMB(long b) {
		BigDecimal trafficKB;
		BigDecimal trafficMB;

		BigDecimal temp = new BigDecimal(b);
		BigDecimal divide = new BigDecimal(1024);
		trafficKB = temp.divide(divide, 2, 1);      // B -> KB
		trafficMB = trafficKB.divide(divide, 2, 1); // KB -> MB
