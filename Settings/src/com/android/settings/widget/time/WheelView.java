...
package com.android.settings.widget.time;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF000BFFF;  //0xF0000000 

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFFFFFFF; // 未选择文字颜色 0xFF000000
	...
	private void drawCenterRect(Canvas canvas) {
		...
		centerDrawable.setBounds(0, center - offset + 40 , getWidth(), center
				+ offset + 40);
