...
public class CreateShortcut extends LauncherActivity {
	...
	private static String TAG = "CreateShortcut";
    @Override
...
//            Log.e(TAG,"czy activityInfo.name ="+info.activityInfo.name);
//            Log.e(TAG,"czy getSimpleName ="+TetherSettingsActivity.class.getSimpleName());
...
//            }
//medify by zhaojr
           // if (!info.activityInfo.name.endsWith("DreamSettingsActivity")
           // 		&&!info.activityInfo.name.endsWith("SoundSettingsActivity")) {
