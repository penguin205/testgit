...
public class Settings extends PreferenceActivity
	...
	private void setDefaultActionBar() {
		...
		mActionBarTitle = (TextView) actionbarLayout.findViewById(R.id.tv_actionbar_title);
	...
	private void setupListView() {
      ...
      if(list !=null){
          list.setDivider(getResources().getDrawable(R.drawable.line_bg));
          LinearLayout lv = (LinearLayout)list.getParent();
          lv.setBackgroundResource(R.drawable.default_wallpaper);
      }
	}
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (headerType) {
                case HEADER_TYPE_CATEGORY:
                    ...
                    holder.title.setTextColor(android.R.color.transparent);
                    break;
