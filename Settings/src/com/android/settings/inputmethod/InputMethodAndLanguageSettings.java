...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        mPointerSettingsCategory = (PreferenceCategory)findPreference(
                "pointer_settings_category"); 
        mVoiceCategory = (PreferenceCategory)findPreference(
                        "voice_category");
        ...
        getPreferenceScreen().removePreference(mKeyboardSettingsCategory);
    }
    ...
    private void updateGameControllers() {
		...
		getPreferenceScreen().removePreference(mPointerSettingsCategory);
        getPreferenceScreen().removePreference(mVoiceCategory);
    }
