...
public class StorageVolumePreferenceCategory extends PreferenceCategory {
	 ...
	 */
	 ...
	 public void init() {
		 ...
		 if(mVolume!=null)path = mVolume.getPath();
	 ...
	 public void updateApproximate(long totalSize, long availSize) {
		 ...
		 mUsageBarPreference.addEntry(0, usedSize / (float) 8000000000l, android.graphics.Color.GRAY);
	 ...
	 public void updateDetails(MeasurementDetails details) {
		 ...
		 updatePreference(mItemMisc, 8000000000l-mTotalSize);
	 ...
	 private void updatePreference(StorageItemPreference pref, long size) {
		 if (size > 0) {
			 ...
			 mUsageBarPreference.addEntry(order, size / (float) 8000000000l, pref.color);
		 } else {
