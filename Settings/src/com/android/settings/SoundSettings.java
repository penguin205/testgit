...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_GLOBAL_VOLUME = "global_volume";
    ...
    private Preference mGlobalVolume;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getPreferenceScreen().removePreference(findPreference(KEY_RING_VOLUME));
        mGlobalVolume = findPreference(KEY_GLOBAL_VOLUME);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        }else if (preference == mGlobalVolume) {
        	int mVolume = -1; 
			Intent intent = new Intent(CommonStatic.USER_VOLUME_CHANGED_ACTION);
			intent.putExtra(CommonStatic.USER_VOLUME_CHANGED_ACTION, 
				CommonStatic.CM_SOUND_MGR_SET_VOLUME);
			intent.putExtra(CommonStatic.USER_EXTRA_VOLUME_VALUE, mVolume);		        
