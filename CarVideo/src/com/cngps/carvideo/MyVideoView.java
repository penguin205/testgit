...
public class MyVideoView extends SurfaceView implements MediaPlayerControl {
	...
	public void setVideoPath(String path, int seekPos) {
		setVideoURI(Uri.parse(path), seekPos);
	}

	public void setVideoURI(Uri uri, int seekPos) {
		mUri = uri;
		mStartWhenPrepared = false;
		mSeekWhenPrepared = seekPos;
		openVideo();
		requestLayout();
		invalidate();
	}
